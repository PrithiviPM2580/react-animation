...
const VerticalPixelBackground = ({ menuIsActive }) => {
  const suffles = (a) => {
    let j, x, i;
    ...
    return delays.map((randomDelay, i) => {
      return (
        <motion.div
          ...
          custom={[indexOfRow + randomDelay, 20 - indexOfRow + randomDelay]}
        ></motion.div>
      );
    });
  };
...
export default VerticalPixelBackground;
